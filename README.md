...
###  Admin Features
- ** Admin Dashboard** – Overview of users, items, claims, and feedback
...
###  System Features
- ** RESTful API** – Flask backend with modular route handling
- ** Scheduled Cleanup** – Auto-deletion of outdated items using APScheduler
- ** Image Upload** – Supports item image uploads and secure storage
- ** MySQL Procedures/Triggers** – Used for claim handling logic
